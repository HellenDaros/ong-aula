      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="bg-stone-50/50 border-b border-stone-100">
            ...
            <th className="px-6 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">E-mail</th>
        ...
        <tbody className="divide-y divide-stone-50">
          {usuarios.map((usuario) => (
            <tr key={usuario.id} className="hover:bg-stone-50/40 transition-colors group">
              <td className="px-6 py-4 text-sm font-bold text-slate-400">#{usuario.id}</td>
              <td className="px-6 py-4">
                <span className="text-sm font-black text-slate-700">{usuario.name}</span>
              </td>
              <td className="px-6 py-4 text-sm font-medium text-slate-500">{usuario.email}</td>
              <td className="px-6 py-4">
